...
export function createEmoteDetectorScriptEvent(event: ScriptEventCommandMessageAfterEvent) {
    ...
    createEntityDetector(EntityCommandTypes.EmoteCommand, entity, commandId, command)
}

/**
 * This removes the entity's emote detector.
 */
export function removeEmoteDetectorScriptEvent(event: ScriptEventCommandMessageAfterEvent) {
    ...
    if (commandId.length === 0) {
        removeEntityDetector(EntityCommandTypes.EmoteCommand, entity, {removeAll: true})
    } else {
        removeEntityDetector(EntityCommandTypes.EmoteCommand, entity, {removeAll: false, id: commandId})
    }
}